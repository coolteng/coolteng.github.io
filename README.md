README《機械手臂展示說明檔》
====
# [《互動式機械臂示範教材展示》](http://arm.cool.nctu.me/)[arm.cool.nctu.me](http://arm.cool.nctu.me/)

此<<互動式機械臂示範教材網站>>http://arm.cool.nctu.me/ 乃由鄧崇林從零奇巧搭建GitHub個人網站所建成，由於會用到筆者過去製作的互動式 Applet 小程式，然而谷歌Chrome 及微軟Edge 瀏覽器不再支援此小程式，因此必須①用 Internet Explorer 瀏覽器以及②設定例外網站清單才能正常執行。
[機械手臂展示](http://arm.cool.nctu.me/)
****
### Author:鄧崇林
### E-mail:coolteng@gmail.com
### 建置本網站的用意
1. 製作客戶端的 JavaScript 動態網頁設計，重點放在動態啟動互動式 Applet 小程式。
2. 設定 DNS 的 CNAME 基本技巧與搭配設定 GitHub Pages 的 Custom domain 有關規範。
3. 不用熟悉git命令，沒錯，這一項可以完全忽略，單純透過網頁操作，就能制霸部署 GitHub 網站。
4. 從零奇巧搭建 GitHub 個人網站，先新建《GitHub 個人網站》，後建《網頁倉庫》，再加以整合而成。
5. 製作由 StrapDown.js 封裝 Markdown 文檔，進而動態轉成 HTML 格式的應用技巧，線上說明就是這樣製作而成的。
6. 提供有關機械手臂在各重點領域方方面面的應用側寫，以及相關的基本設計與製作，從而建立由外到裡的通盤認知。
7. 支持線上互動學習機械手臂其背後的正向運動學（Forward Kinematics），以及逆向運動學（Inverse Kinematics）。
****
## 🏁 目錄
* [👍建置本網站的用意](#建置本網站的用意)
* [👍線上驗證 Java 版本](#clteng)
...
* 2.4.按一下「位置」欄位下空白的欄位，分別新增輸入下列兩個 URL：
  * 2.4.1.URL：http://arm.cool.nctu.me/
  * 2.4.2.URL：http://robotics.ee.uwa.edu.au
* 2.5.按一下【確定】按鈕以儲存您輸入的 URL，如下圖所示。如果按一下【取消】按鈕，則不會儲存 URL。
>![IEsetting](http://arm.cool.nctu.me/myPage/armMenu/TWID28跟著調整Java設定.PNG "")
* 2.6.按一下前述新生「安全性警告」對話方塊中的【繼續】按鈕。

------
### 機械臂互動式示範教學
- 機械臂互動式示範教學，開啟 Internet Explorer 瀏覽器並輸入網址：http://arm.cool.nctu.me/
- 成功開啟後的畫面如下圖所示(會與瀏覽器不同而有差異)，若點擊畫面左下角大拇指選項，也能線上閱讀說明：
>![clt02](http://arm.cool.nctu.me/myPage/armMenu/擷取m00.PNG "")

- 如用微軟 Edge 瀏覽器時，請依下圖切換成 IE 瀏覽器：
>![clt03](http://arm.cool.nctu.me/myPage/armMenu/擷取m001由Edge切換IE.PNG "")

- 當微軟 IE 瀏覽器初次執行本機械臂互動網頁時會出現下圖警示，請續按【稍後詢問我】即可
>![clt04](http://arm.cool.nctu.me/myPage/armMenu/擷取m002續按稍後詢問我.PNG "")

- 當執行互動式 Applet 小程式時會出現下圖警示，請續按【執行】即可
>![clt05](http://arm.cool.nctu.me/myPage/armMenu/擷取003執行Java的安全警告續按執行即可.PNG "")
...
>![arm11](http://arm.cool.nctu.me/myPage/armMenu/擷取m11.PNG "")
...
>![arm12](http://arm.cool.nctu.me/myPage/armMenu/擷取m12.PNG "")
...
>![arm13](http://arm.cool.nctu.me/myPage/armMenu/擷取m13.PNG "")
...
>![arm14](http://arm.cool.nctu.me/myPage/armMenu/擷取m14.PNG "")
...
>![arm15](http://arm.cool.nctu.me/myPage/armMenu/擷取m15.PNG "")
...
>![arm16](http://arm.cool.nctu.me/myPage/armMenu/擷取m16.PNG "")
...
>![arm17](http://arm.cool.nctu.me/myPage/armMenu/擷取m17.PNG "")
...
>![arm18](http://arm.cool.nctu.me/myPage/armMenu/擷取m18.PNG "")
...
>![arm19](http://arm.cool.nctu.me/myPage/armMenu/擷取m19.PNG "")
...
>![arm21](http://arm.cool.nctu.me/myPage/armMenu/擷取m21.PNG "")
...
* 此為互動式 Applet 小程式
>![arm22](http://arm.cool.nctu.me/myPage/armMenu/擷取m22.PNG "")
...
* 此為互動式 Applet 小程式
>![arm23](http://arm.cool.nctu.me/myPage/armMenu/擷取m23.PNG "")
...
* 此為互動式 Applet 小程式
>![arm24](http://arm.cool.nctu.me/myPage/armMenu/擷取m24.PNG "")
...
>![arm25](http://arm.cool.nctu.me/myPage/armMenu/擷取m25拉動左側垂直滑桿可對應控制同色系的手臂部位.PNG "")
...
>![arm26](
http://arm.cool.nctu.me/myPage/armMenu/擷取m26左右拉動下方水平角度數值可控制手爪俯仰角的運動設定.PNG ""
)
...
>![arm27](
http://arm.cool.nctu.me/myPage/armMenu/擷取m27上下拉動左側垂直滑桿之角度數值可控制手爪俯仰角的運動設定.PNG ""
)
...
>![arm28](
http://arm.cool.nctu.me/myPage/armMenu/擷取m28左右拉動下方水平滑桿可控制手爪俯仰角的運動設定.PNG ""
)
 ...
 * 此為互動式 Applet 小程式，左右拉動下方水平滑桿可控制手爪俯仰角的運動設定
>![arm29](http://arm.cool.nctu.me/myPage/armMenu/擷取m29左右拉動下方水平滑桿可控制手爪俯仰角的運動設定.PNG "")
 ...
 * 此為互動式 Applet 小程式，左右拉動下方水平滑桿可控制手爪俯仰角的運動設定
>![arm2A](
http://arm.cool.nctu.me/myPage/armMenu/擷取m2A左右拉動下方水平滑桿可控制手爪俯仰角的運動設定.PNG ""
)
...
>![arm31](http://arm.cool.nctu.me/myPage/armMenu/擷取m31.PNG "")
...
>![arm32](http://arm.cool.nctu.me/myPage/armMenu/擷取m32.PNG "")
...
>![arm33](http://arm.cool.nctu.me/myPage/armMenu/擷取m33.PNG "")
...
>![arm41](http://arm.cool.nctu.me/myPage/armMenu/擷取m41.PNG "")
...
>![arm42](http://arm.cool.nctu.me/myPage/armMenu/擷取m42滑鼠點按網線托拉移位後再放下後有動態現象發生.PNG "")
...
>![arm43](http://arm.cool.nctu.me/myPage/armMenu/擷取m43在畫面中上下移動滑鼠會有動態現象發生.PNG "")
...
>![arm44](http://arm.cool.nctu.me/myPage/armMenu/擷取m44在畫面中上下隨處點按滑鼠會有動態現象發生.PNG "")
...
>![arm45](http://arm.cool.nctu.me/myPage/armMenu/擷取m45只能在IE中有條件顯示.PNG "")
...
>![arm51](http://arm.cool.nctu.me/myPage/armMenu/擷取m51.PNG "")
...
>![arm52](http://arm.cool.nctu.me/myPage/armMenu/擷取m52.PNG "")
...
>![arm53](http://arm.cool.nctu.me/myPage/armMenu/擷取m53.PNG "")
...
>![arm54](http://arm.cool.nctu.me/myPage/armMenu/擷取m54.PNG "")
...
>![arm55](http://arm.cool.nctu.me/myPage/armMenu/擷取m55.PNG "")
